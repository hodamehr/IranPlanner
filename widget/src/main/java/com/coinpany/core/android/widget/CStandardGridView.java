 ...
 */
public class CStandardGridView extends GridView {

    private OnOverScrollByHandler onOverScrollByHandler;
    public boolean expandWholeHeight = false;

    public CStandardGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CStandardGridView(Context context, AttributeSet attrs, int defStyle) {
